...
export function DashboardSettings({ username, persistChanges, stream, uploadConfigured }: { username: string; persistChanges: boolean; stream: { name: string; thumbnailUrl: string | null; isChatEnabled: boolean; isChatDelayed: boolean; isChatFollowersOnly: boolean }; uploadConfigured: boolean }) {
  ...
  return (
    <div className="space-y-6 p-6 lg:p-10">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-black">{username}&apos;s stream</h1>
